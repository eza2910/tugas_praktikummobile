        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text("Order Summary"),
                summaryText("Items", "$totalItems"), // ✅ FIXED
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: const BoxDecoration(
            shape: BoxShape.circle, color: Color(0xFFEDEBFD)),
